...
/**
 * Various examples of using Jena 
...
class HelloJena {
	...
	/**
	 * Reads a remote (Web-accessible) ttl file, loads it as a model,  and prints its contents
	 */
	 void readTriplesFromTheWeb() {
		   String urlstr="https://people.uib.no/sinoa/test.ttl"; // a ttl file store in the web (Norway)
	...
	void testSPARQLqueries() {
	    ...
	    System.out.println("\n--[SELECT query from remote SPARQL endpoint (getting 10 persons from dbpedia) ]--");

...
public final class MappingUtils {
    ...
    public static  Map<String, String> getStringStringMap(Map<String, Object> map, String key) {
        Object v = map.get(key);
    ...
    public static  Map<String, String> coalescePortMappings(Map<String, Object> raw, String preferredKey, String altKey) {
